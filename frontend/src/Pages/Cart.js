              ...
              <div className="col-lg-8">
                <div className="container-fluid">
                  ...
                  {cart?.map(p =>(
                    ...
                    <div className="col-4 col-md-2  col-lg-2 col-xl-2 mb-2">
                      <img src={`/api/v1/product/product-photo/${p?._id}`} className="img-fluid rounded-3" alt="Cotton T-shirt" />
                    </div>
                    <div className="col-4 col-md-3 col-lg-3 col-xl-3">
                      <h5 className="colr">{p.name}</h5>
                      <h6 className="text-black">{p.description.substring(0,15)}...</h6>
                    </div>
                    ...
                    onClick={()=>removeCartItem(p._id)}>
                      <MDBIcon className='pt-2 pb-2 trash-ic' icon='trash-can' size='lg' />
                    </div>
                  </div>
                  <hr className="my-4" />
                    </>
